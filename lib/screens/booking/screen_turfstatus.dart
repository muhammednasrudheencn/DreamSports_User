            ...
            builder: (context, snapshot) {
              ...
              return StreamBuilder(
                  ...
                  builder: (context, avatar) {
                    if (avatar.connectionState == ConnectionState.waiting) {
                      return const Center(child: CircularProgressIndicator());
                    }
                    if (!avatar.hasData) {
                      return const Center(child: CircularProgressIndicator());
                    }
                    final turfavatar = avatar.data!.docs[0]['turfavatar'];
                            ...
                            Center(
                              child: Padding(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: CircleAvatar(
                                    radius: 48,
                                    backgroundImage: NetworkImage(turfavatar),
                                  ),
                                ),
                              ),
                            )
